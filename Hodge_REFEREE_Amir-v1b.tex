...
By Proposition~\ref{prop:almost-calibration}\textnormal{(ii)}, this forces the calibration defect of $T_\epsilon=S_\epsilon-U_\epsilon$ to vanish, so any subsequential
...
\medskip\noindent
\editamir{\textbf{Substep 6.2: Compactness (integral currents).}}
\begin{editamirblock}

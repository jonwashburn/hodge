...
| `omega_closed` | `IsFormClosed omega_form` | dω = 0 |
| `omega_positive` | Positivity statement | Standard Kähler condition |
| `omega_is_pp` | `isPPForm' n X 1 omega_form` | ω is a (1,1)-form |
| `omega_rational_witness` | `IsRationalFormWitness` | [ω] is rational |
| `omega_J_invariant` | J-invariance | Kähler identity |

**Note**: Hard Lefschetz is **NOT** a field of `KahlerManifold`. It was removed because:

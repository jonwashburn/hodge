...
For the resulting \(1\)-jets \(ds_{a,m}(0)\) to be \(O(1)\) (hence uniformly invertible) on Bergman balls of radius \(\asymp m^{-1/2}\),
the normalization factor must be \(m^{-(n+1/2)}\) (not \(m^{-(n+1)/2}\)).
...
\(\sup_{|Z|\le\sigma}\|ds_{a,m}(Z)-ds_{a,m}(0)\|\le \varepsilon\).

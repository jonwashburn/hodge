...
/-- **Theorem: Radial Minimization**
    ...
    where λ* = max(0, ⟨α, ξ⟩).
    This is a standard property of projection onto a convex set (the ray).
    Reference: [Rockafellar, "Convex Analysis", Princeton, 1970, Section 12]. -/
...
/-- **Theorem: Pointwise Calibration Distance Formula**.
    ...
    Follows from the properties of projection onto a convex cone generated by unit vectors.

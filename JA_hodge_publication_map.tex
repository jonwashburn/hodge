...
% PUBMAP overview inserted automatically
\section*{Publication Map}
This annotated copy is a planning artifact rather than a submission draft. It keeps the source text intact while tagging sections and theorem-like items according to the Lean-audited proof spine and the intended publication split.
\begin{itemize}
\item \textbf{Flagship paper.} Keep the closure chain centered on Theorems~\ref{thm:spine-quantitative}, \ref{thm:realization-from-almost}, \ref{thm:automatic-syr}, \ref{thm:effective-algebraic}, and \ref{thm:main-hodge}, together with Propositions~\ref{prop:glue-gap}, \ref{prop:cohomology-match}, and \ref{prop:almost-calibration}, plus the signed-decomposition finish in Lemmas~\ref{lem:signed-decomp} and \ref{lem:gamma-minus-alg}.
\item \textbf{Flagship interfaces.} Retain only statement-level import contracts for the local and assembly packages, especially Propositions~\ref{prop:h1-package} and \ref{prop:h2-package}, and compress notation to what the closure chain actually uses.
\item \textbf{Companion local paper.} Move the Bergman/tangent/template/local-sheet cluster centered on Lemma~\ref{lem:jet-surjectivity}, Lemma~\ref{lem:bergman-control}, Proposition~\ref{prop:tangent-approx-full}, Proposition~\ref{prop:finite-template}, and Theorem~\ref{thm:local-sheets}.
\item \textbf{Companion assembly paper.} Move the Carath\'eodory/weights/global-coherence/quantization cluster centered on Lemma~\ref{lem:caratheodory-general}, Lemma~\ref{lem:lipschitz-qp-weights}, Proposition~\ref{prop:corner-exit-template-net}, Theorem~\ref{thm:global-cohom}, and Proposition~\ref{prop:global-coherence-all-labels}.
\item \textbf{Appendix.} Relegate the K\"ahler preliminaries, cone-geometry background, energy-gap estimates, explicit net bounds, linear-algebra detours, and calibration--coercivity section unless a flagship proof uses them directly.
\item \textbf{Formal supplement.} Relegate discrepancy bookkeeping, classical filling/period lemmas, variant template branches, and Lean-facing audit material that supports but does not define the journal-facing narrative.
\end{itemize}
\noindent\textbf{Lean anchors.} \texttt{A10} tracks the microstructure/SYR existence chain, \texttt{A9} tracks the final geometric-to-cohomological bridge, and \texttt{A4}--\texttt{A6} record the classical compactness/regularity/algebraicity inputs that should usually be cited rather than re-proved in the flagship paper.
\medskip
% PUBMAP kind=section; labels=sec:notation; bucket=flagship-interface; lean=proof-spine-overview; action=shorten-to-statement; destination=flagship paper
...
% PUBMAP kind=definition; labels=def:mass; bucket=appendix; lean=classical-input; action=cite-as-classical; destination=appendix
...
% PUBMAP kind=definition; labels=def:flat-norm; bucket=appendix; lean=classical-input; action=cite-as-classical; destination=appendix
...
% PUBMAP kind=section; labels=--; bucket=flagship; lean=proof-spine-overview; action=keep; destination=flagship paper
...
% PUBMAP kind=subsection; labels=--; bucket=flagship-interface; lean=proof-spine-overview; action=keep; destination=flagship paper
\subsection*{Problem}
...
% PUBMAP kind=subsection; labels=--; bucket=appendix; lean=background; action=move; destination=appendix
\subsection*{Main quantitative theorem (calibration--coercivity, explicit)}

% PUBMAP kind=remark; labels=rem:spine-theorem-interpretation,thm:cal-coercivity-intro; bucket=appendix; lean=background; action=move; destination=appendix
\begin{remark}
...
% PUBMAP kind=subsection; labels=--; bucket=flagship; lean=proof-spine-overview; action=keep; destination=flagship paper
...
% PUBMAP kind=subsection; labels=--; bucket=flagship-interface; lean=proof-spine-overview; action=shorten-to-statement; destination=flagship paper
...
% PUBMAP kind=section; labels=sec:kahler-prelim; bucket=appendix; lean=background; action=move; destination=appendix
...
% PUBMAP kind=section; labels=--; bucket=appendix; lean=background; action=move; destination=appendix
...
% PUBMAP kind=lemma; labels=lem:calibrated-cone-closed; bucket=appendix; lean=background; action=move; destination=appendix
...
% PUBMAP kind=lemma; labels=lem:radial-min; bucket=appendix; lean=background; action=move; destination=appendix
...
% PUBMAP kind=lemma; labels=lem:trace-L2; bucket=appendix; lean=background; action=move; destination=appendix
...
% PUBMAP kind=proposition; labels=prop:dist-cal-properties; bucket=appendix; lean=background; action=move; destination=appendix
...
% PUBMAP kind=lemma; labels=lem:kahler-angle; bucket=appendix; lean=background; action=move; destination=appendix
...
% PUBMAP kind=remark; labels=--; bucket=appendix; lean=background; action=move; destination=appendix
...
% PUBMAP kind=lemma; labels=lem:elliptic-coulomb; bucket=appendix; lean=background; action=move; destination=appendix
...
% PUBMAP kind=lemma; labels=lem:coulomb; bucket=appendix; lean=background; action=move; destination=appendix
...
% PUBMAP kind=subsection; labels=sec:epsnets; bucket=appendix; lean=background; action=move; destination=appendix
...
% PUBMAP kind=lemma; labels=lem:covering-number; bucket=appendix; lean=background; action=move; destination=appendix
...
% PUBMAP kind=lemma; labels=lem:typesplit; bucket=appendix; lean=background; action=move; destination=appendix
...
% PUBMAP kind=lemma; labels=lem:hermitian-model; bucket=appendix; lean=background; action=move; destination=appendix
...
% PUBMAP kind=remark; labels=rem:cone-not-full-psd; bucket=appendix; lean=background; action=move; destination=appendix
...
% PUBMAP kind=lemma; labels=lem:rankone; bucket=appendix; lean=background; action=move; destination=appendix
...
% PUBMAP kind=proposition; labels=prop:pp-projection; bucket=appendix; lean=background; action=move; destination=appendix
...
% PUBMAP kind=corollary; labels=cor:Dpsd-pointwise; bucket=appendix; lean=background; action=move; destination=appendix
...
% PUBMAP kind=theorem; labels=thm:cal-coercivity; bucket=appendix; lean=background; action=move; destination=appendix
...
% PUBMAP kind=remark; labels=rem:coercivity-hypothesis; bucket=appendix; lean=background; action=move; destination=appendix
...
% ============================================================
% PUBMAP kind=section; labels=sec:realization; bucket=flagship-interface; lean=A10/A9; action=shorten-to-statement; destination=flagship paper + companion papers
...
% PUBMAP kind=subsection; labels=--; bucket=flagship; lean=A10; action=keep; destination=flagship paper
\subsection*{Spine theorem: a single checkable quantitative output}

% PUBMAP kind=theorem; labels=thm:spine-quantitative; bucket=flagship; lean=A10; action=keep; destination=flagship paper
...
% PUBMAP kind=remark; labels=--; bucket=flagship; lean=A10; action=keep; destination=flagship paper
...
% PUBMAP kind=subsection; labels=--; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=subsection; labels=--; bucket=flagship-interface; lean=A10-interface; action=shorten-to-statement; destination=flagship paper
\subsection*{H1/H2 packaged at the point of use (for Theorem~\ref{thm:spine-quantitative})}

% PUBMAP kind=proposition; labels=prop:h1-package; bucket=flagship-interface; lean=A10-interface; action=shorten-to-statement; destination=flagship paper (statement only); companion local paper
...
% PUBMAP kind=proposition; labels=prop:h2-package; bucket=flagship-interface; lean=A10-interface; action=shorten-to-statement; destination=flagship paper (statement only); companion assembly paper
...
% ------------------------------------------------------------
% PUBMAP kind=subsection; labels=--; bucket=flagship; lean=A4-A6; action=keep; destination=flagship paper
\subsection*{Closure from almost-calibrated sequences}

% PUBMAP kind=lemma; labels=lem:flat_limit_of_cycles_is_cycle,lem:cone-closed-seq; bucket=formal-supplement; lean=A4; action=cite-as-classical; destination=formal supplement
...
% PUBMAP kind=theorem; labels=thm:realization-from-almost,thm:cone-closed-FF; bucket=flagship; lean=A4-A6; action=keep; destination=flagship paper
...
% PUBMAP kind=lemma; labels=lem:limit_is_calibrated; bucket=formal-supplement; lean=A4-A6; action=cite-as-classical; destination=formal supplement
...
% PUBMAP kind=remark; labels=rem:cone-closed-what-used; bucket=flagship; lean=A4-A6; action=keep; destination=flagship paper
...
% ------------------------------------------------------------
% PUBMAP kind=subsection; labels=--; bucket=appendix; lean=classical-input; action=cite-as-classical; destination=appendix
\subsection*{complete realizability in codimension one (Lefschetz (1,1))}


% PUBMAP kind=theorem; labels=thm:codim1,thm:lefschetz11; bucket=appendix; lean=classical-input; action=cite-as-classical; destination=appendix
...
% PUBMAP kind=remark; labels=--; bucket=appendix; lean=classical-input; action=cite-as-classical; destination=appendix
...
% PUBMAP kind=proposition; labels=prop:complete-intersection,thm:complete-intersection; bucket=appendix; lean=classical-input; action=cite-as-classical; destination=appendix
...
% PUBMAP kind=definition; labels=def:syr; bucket=flagship-interface; lean=A10; action=keep; destination=flagship paper
...
% PUBMAP kind=remark; labels=rem:syr-criterion; bucket=flagship; lean=A4-A6; action=keep; destination=flagship paper
...
% PUBMAP kind=theorem; labels=thm:syr,prop:realizability-stationary; bucket=flagship; lean=A4-A6; action=keep; destination=flagship paper
...
% PUBMAP kind=remark; labels=rem:syr-remark; bucket=flagship; lean=A4-A6; action=keep; destination=flagship paper
...
% ------------------------------------------------------------
% PUBMAP kind=subsection; labels=--; bucket=formal-supplement; lean=classical-input; action=move; destination=formal supplement
...
% PUBMAP kind=definition; labels=--; bucket=formal-supplement; lean=classical-input; action=move; destination=formal supplement
...
% PUBMAP kind=theorem; labels=thm:classical-syr-licd; bucket=formal-supplement; lean=classical-input; action=cite-as-classical; destination=formal supplement
...
% PUBMAP kind=corollary; labels=cor:closure-licd; bucket=formal-supplement; lean=classical-input; action=move; destination=formal supplement
...
% PUBMAP kind=subsection; labels=--; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=definition; labels=def:caratheodory-decomp; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=lemma; labels=lem:caratheodory-general; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=remark; labels=rem:caratheodory-quantitative; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=lemma; labels=lem:lipschitz-qp-weights; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=remark; labels=rem:direction-net-qp; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% ------------------------------------------------------------
% PUBMAP kind=subsection; labels=--; bucket=companion-local; lean=local-construction; action=move; destination=companion local paper
...
% PUBMAP kind=lemma; labels=lem:jet-surjectivity; bucket=companion-local; lean=local-construction; action=move; destination=companion local paper
...
% PUBMAP kind=lemma; labels=lem:bergman-control; bucket=companion-local; lean=local-construction; action=move; destination=companion local paper
...
% PUBMAP kind=remark; labels=--; bucket=companion-local; lean=local-construction; action=move; destination=companion local paper
...
% PUBMAP kind=lemma; labels=lem:graph-from-grad,lem:linear-graph-geometry; bucket=companion-local; lean=local-construction; action=move; destination=companion local paper
...
% PUBMAP kind=proposition; labels=prop:tangent-approx-full,thm:tangent-approx; bucket=companion-local; lean=local-construction; action=move; destination=companion local paper
...
\end{proof}
% PUBMAP kind=proposition; labels=prop:dense-holo; bucket=companion-local; lean=local-construction; action=move; destination=companion local paper
...
% PUBMAP kind=lemma; labels=lem:complex-corner-exit-template; bucket=companion-local; lean=local-construction; action=move; destination=companion local paper
...
\end{proof}
% PUBMAP kind=remark; labels=rem:corner-exit-intuition; bucket=companion-local; lean=local-construction; action=move; destination=companion local paper
...
% PUBMAP kind=lemma; labels=lem:small-graph-distortion; bucket=companion-local; lean=local-construction; action=move; destination=companion local paper
...
% PUBMAP kind=lemma; labels=lem:corner-exit-mass-scale; bucket=companion-local; lean=local-construction; action=move; destination=companion local paper
...
% PUBMAP kind=lemma; labels=lem:corner-simplex-face-mass; bucket=companion-local; lean=local-construction; action=move; destination=companion local paper
...
% PUBMAP kind=proposition; labels=prop:holomorphic-corner-exit-g1g2; bucket=companion-local; lean=local-construction; action=move; destination=companion local paper
...
% PUBMAP kind=lemma; labels=lem:sliver-stability; bucket=companion-local; lean=local-construction; action=move; destination=companion local paper
...
% PUBMAP kind=remark; labels=rem:sliver-stability-discussion; bucket=companion-local; lean=local-construction; action=move; destination=companion local paper
...
% PUBMAP kind=proposition; labels=prop:finite-template; bucket=companion-local; lean=local-construction; action=move; destination=companion local paper
...
% PUBMAP kind=remark; labels=rem:matching-cells-geometry; bucket=companion-local; lean=local-construction; action=move; destination=companion local paper
...
% PUBMAP kind=proposition; labels=prop:holomorphic-corner-exit-L1; bucket=companion-local; lean=local-construction; action=move; destination=companion local paper
...
% PUBMAP kind=definition; labels=def:holomorphic-scale; bucket=companion-local; lean=local-construction; action=move; destination=companion local paper
...
\end{definition}
% PUBMAP kind=theorem; labels=thm:local-sheets; bucket=companion-local; lean=local-construction; action=move; destination=companion local paper
...
% PUBMAP kind=lemma; labels=lem:face-trace-decomposition; bucket=companion-local; lean=local-construction; action=move; destination=companion local paper
...
% PUBMAP kind=lemma; labels=lem:local-bary; bucket=companion-local; lean=local-construction; action=move; destination=companion local paper
...
% PUBMAP kind=remark; labels=rem:weighted-scaling; bucket=companion-local; lean=local-construction; action=move; destination=companion local paper
...
% PUBMAP kind=lemma; labels=lem:corner-exit-template-open; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=proposition; labels=prop:corner-exit-template-net; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=theorem; labels=thm:global-cohom; bucket=companion-assembly; lean=exact-class-locking; action=move; destination=companion assembly paper
...
% PUBMAP kind=remark; labels=rem:global-cohom-commentary; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=remark; labels=rem:main-quantifiers; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=definition; labels=def:coherent-templates; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=lemma; labels=lem:coherence-implies-closed; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=definition; labels=def:face-maps; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=lemma; labels=lem:face-map-stability; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=proposition; labels=prop:transport-flat-glue,prop:transport-cell; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=remark; labels=rem:transport-hypotheses; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=lemma; labels=lem:w1-auto; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=definition; labels=def:cell-transport-plan; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=lemma; labels=lem:w1-integral-optimal,lem:transport-exists; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=lemma; labels=lem:face-displacement; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=lemma; labels=lem:w1-template-edit; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=remark; labels=rem:w1-auto; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=remark; labels=rem:sliver-vs-template; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=definition; labels=def:sliver-cell; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=proposition; labels=prop:sliver-cell-mass-proportions; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=lemma; labels=lem:flat-translate; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=lemma; labels=lem:flat-C0-deform; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=lemma; labels=lem:flat-diameter; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=lemma; labels=lem:template-displacement; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=lemma; labels=lem:template-displacement-edits; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=lemma; labels=lem:template-edits-oh; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=proposition; labels=prop:prefix-template-coherence; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=remark; labels=rem:why-prefix; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=proposition; labels=prop:sliver-template-extension; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=remark; labels=rem:sliver-template-extension; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=proposition; labels=prop:transport-flat-glue-weighted; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=proposition; labels=prop:integer-transport; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=remark; labels=--; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=lemma; labels=lem:uniformly-convex-slice-boundary; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=lemma; labels=lem:face-slice-cycle-mass; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=corollary; labels=cor:global-flat-weighted; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=lemma; labels=lem:borderline-p-half; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=remark; labels=rem:no-vanishing-piece-mass; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=remark; labels=rem:sliver-bergman-scaling; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=remark; labels=rem:w1-multiplicity; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=remark; labels=rem:bounded-corrections; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=remark; labels=rem:nested-template-scheme; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=lemma; labels=lem:sliver-template-glue-flat; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=proposition; labels=prop:sliver-template-glue; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=proposition; labels=prop:sliver-template-global; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=remark; labels=rem:sliver-quantifier-remark; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=proposition; labels=prop:sliver-mass-matching; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=remark; labels=rem:sliver-matching-remark; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=theorem; labels=thm:sliver-mass-matching-on-template; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=remark; labels=rem:activation-hypotheses-status; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=remark; labels=rem:sliver-cube-templates; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=remark; labels=rem:sliver-template-candidates; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=proposition; labels=prop:prefix-activation-flat-ball; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=corollary; labels=cor:prefix-activation-holo; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=lemma; labels=lem:oh-face-edit-regime; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=remark; labels=rem:iv-what-remains; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=remark; labels=rem:param-tension; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
\end{remark}
% PUBMAP kind=remark; labels=rem:lefschetz-reduction; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=lemma; labels=lem:mass-tunable; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=remark; labels=rem:sliver; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=lemma; labels=lem:sphere-quantize; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=lemma; labels=lem:sphere-quantize-nested; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=proposition; labels=prop:flat-sliver-local; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=corollary; labels=cor:holomorphic-flat-sliver-local; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=conjecture; labels=conj:sliver-local; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=remark; labels=rem:sliver-cell-shape; bucket=companion-assembly; lean=packet-assembly; action=move; destination=companion assembly paper
...
% PUBMAP kind=remark; labels=rem:sharp-cube-variant-status; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=remark; labels=rem:why-corners; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=remark; labels=rem:sharp-cube-why; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=definition; labels=def:vertex-template; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=lemma; labels=lem:vertex-template-exists; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=remark; labels=rem:corner-exit-direction-net,rem:vertex-template-remarks; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=lemma; labels=lem:cube-vertex-slice-boundary; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=proposition; labels=prop:vertex-template-mass-matching; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=proposition; labels=prop:vertex-template-face-edits; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=corollary; labels=cor:corner-exit-iii-iv; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=remark; labels=rem:L1-downstream-map; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=proposition; labels=prop:global-coherence-all-labels; bucket=companion-assembly; lean=A10-interface; action=move; destination=companion assembly paper
...
% PUBMAP kind=proposition; labels=prop:cohomology-match; bucket=flagship; lean=exact-class-locking; action=keep; destination=flagship paper
...
% PUBMAP kind=proposition; labels=prop:almost-calibration; bucket=flagship; lean=A10; action=keep; destination=flagship paper
...
% PUBMAP kind=corollary; labels=cor:raw-boundary-flat-small,prop:global-flat-control; bucket=companion-assembly; lean=A10-interface; action=move; destination=companion assembly paper
...
% PUBMAP kind=remark; labels=--; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=definition; labels=def:checkerboard-anchoring; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=definition; labels=def:block-uniform-codes; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=lemma; labels=lem:prefix-discrepancy,lem:template-vertex-control; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=lemma; labels=lem:two-sided-face-pop; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=proposition; labels=prop:checkerboard-face-oh-edit,prop:template-edits; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=remark; labels=rem:template-edits-remark; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=remark; labels=rem:smooth-cells; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=remark; labels=rem:bergman-not-enough; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=lemma; labels=lem:global-graph-contraction; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=remark; labels=rem:graph-whole-cell; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=lemma; labels=lem:bergman-affine-approx-hormander; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=proposition; labels=prop:cell-scale-linear-model-graph; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=definition; labels=def:graph-template; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=remark; labels=rem:graph-template-remark; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=lemma; labels=lem:graph-template-exists; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=remark; labels=rem:global-graph-plan; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=definition; labels=def:graph-restriction-maps; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=proposition; labels=prop:graph-template-transport; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=lemma; labels=lem:graph-template-flat-control; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=proposition; labels=prop:graph-template-global; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=remark; labels=rem:graph-flat-remark; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=lemma; labels=lem:graph-boundary-correction; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=remark; labels=rem:graph-boundary-remark; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% ================================
% PUBMAP kind=lemma; labels=lem:ball-excludes-faces; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=lemma; labels=lem:corner-simplex-hits-designated-faces; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=corollary; labels=cor:holomorphic-corner-exit-inherits; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=lemma; labels=lem:sliver-packing; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=remark; labels=rem:vertex-star-coherence; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=lemma; labels=lem:slow-variation-rounding; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=lemma; labels=lem:vertex-template-discrete; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=remark; labels=rem:vertex-template-discrete; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=proposition; labels=prop:vertex-template-transport; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=proposition; labels=prop:graph-vertex-compatibility; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=remark; labels=rem:graph-vertex-compatibility; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=proposition; labels=prop:graph-global-coherence; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=remark; labels=rem:graph-global-coherence; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=remark; labels=rem:graph-activation; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=remark; labels=rem:global-graph-summary; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% ================================
% PUBMAP kind=lemma; labels=lem:slow-variation-discrepancy; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=lemma; labels=lem:per-cell-flat-control; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=lemma; labels=lem:flatnorm-gluing-mismatch; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=remark; labels=rem:lean-bottleneck-flatnorm,rem:global-flat-note; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=lemma; labels=lem:FF-filling-X; bucket=formal-supplement; lean=A4; action=cite-as-classical; destination=formal supplement
...
% PUBMAP kind=proposition; labels=prop:glue-gap,prop:glue-cell; bucket=flagship; lean=A10; action=keep; destination=flagship paper
...
% PUBMAP kind=remark; labels=rem:glue-scaling,rem:glue-gap-remark; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=lemma; labels=lem:barany-grinberg; bucket=formal-supplement; lean=exact-class-locking; action=cite-as-classical; destination=formal supplement
...
% PUBMAP kind=lemma; labels=lem:integral-periods; bucket=formal-supplement; lean=classical-input; action=cite-as-classical; destination=formal supplement
...
% ------------------------------------------------------------
% PUBMAP kind=subsection; labels=--; bucket=formal-supplement; lean=A10; action=move; destination=formal supplement
\subsection*{Step 5: Boundary correction with vanishing mass}


% PUBMAP kind=lemma; labels=lem:boundary-template; bucket=formal-supplement; lean=A10; action=move; destination=formal supplement
...
% PUBMAP kind=remark; labels=rem:boundary-template-comment; bucket=formal-supplement; lean=A10; action=move; destination=formal supplement
...
% PUBMAP kind=theorem; labels=thm:boundary-correction; bucket=formal-supplement; lean=A10; action=move; destination=formal supplement
...
% PUBMAP kind=definition; labels=def:lattice-template; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=remark; labels=rem:lattice-template-remark; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=lemma; labels=lem:lattice-template-exists; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=remark; labels=rem:lattice-template-qualitative; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=proposition; labels=prop:lattice-template-transport; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=proposition; labels=prop:lattice-template-global; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=remark; labels=rem:lattice-flat-remark; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=lemma; labels=lem:lattice-vertex-control; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=remark; labels=rem:lattice-vertex-control; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=proposition; labels=prop:lattice-vertex-compatibility; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=remark; labels=rem:lattice-vertex-compatibility; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=proposition; labels=prop:lattice-global-coherence; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=remark; labels=rem:lattice-global-coherence; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=remark; labels=rem:lattice-summary; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=remark; labels=rem:lattice-activation; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
%
% PUBMAP kind=remark; labels=rem:lattice-activation-remark; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=lemma; labels=lem:lattice-discreteness; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=remark; labels=rem:correction-not-positive; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% ------------------------------------------------------------
% PUBMAP kind=subsection; labels=--; bucket=formal-supplement; lean=A4-A6; action=move; destination=formal supplement
...
% PUBMAP kind=theorem; labels=thm:syr-realization; bucket=formal-supplement; lean=A4-A6; action=move; destination=formal supplement
...
% PUBMAP kind=remark; labels=rem:syr-realization-comment; bucket=formal-supplement; lean=A4-A6; action=move; destination=formal supplement
...
% PUBMAP kind=remark; labels=rem:varifold-compactness-used; bucket=formal-supplement; lean=A4-A6; action=move; destination=formal supplement
...
% PUBMAP kind=corollary; labels=cor:syr-limit-holomorphic-chain; bucket=formal-supplement; lean=A4-A6; action=move; destination=formal supplement
...
% PUBMAP kind=remark; labels=rem:mass-vanishes; bucket=formal-supplement; lean=A4-A6; action=move; destination=formal supplement
...
% PUBMAP kind=remark; labels=rem:what-about-integrality; bucket=formal-supplement; lean=A4-A6; action=move; destination=formal supplement
...
% PUBMAP kind=remark; labels=rem:density-mass; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=remark; labels=rem:hl-applicable; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=remark; labels=rem:gluing; bucket=formal-supplement; lean=formal-audit; action=move; destination=formal supplement
...
% PUBMAP kind=theorem; labels=thm:automatic-syr; bucket=flagship; lean=A10; action=keep; destination=flagship paper
...
\end{theorem}
% PUBMAP kind=remark; labels=rem:automatic-syr-comment; bucket=flagship; lean=A10; action=keep; destination=flagship paper
...
% ============================================================
% PUBMAP kind=subsection; labels=--; bucket=flagship; lean=signed-decomposition; action=keep; destination=flagship paper
...
% PUBMAP kind=definition; labels=--; bucket=flagship; lean=signed-decomposition; action=keep; destination=flagship paper
...
% PUBMAP kind=lemma; labels=lem:kahler-positive; bucket=flagship-interface; lean=signed-decomposition; action=keep; destination=flagship paper
...
% PUBMAP kind=lemma; labels=lem:signed-decomp,thm:signed-decomp; bucket=flagship; lean=signed-decomposition; action=keep; destination=flagship paper
...
\end{proof}
% PUBMAP kind=corollary; labels=cor:signed-decomp-usage; bucket=flagship-interface; lean=signed-decomposition; action=keep; destination=flagship paper
...
% PUBMAP kind=remark; labels=rem:signed-decomp-comment; bucket=flagship; lean=signed-decomposition; action=keep; destination=flagship paper
...
% PUBMAP kind=lemma; labels=lem:gamma-minus-alg; bucket=flagship; lean=classical-input; action=cite-as-classical; destination=flagship paper
...
% PUBMAP kind=theorem; labels=thm:effective-algebraic; bucket=flagship; lean=A10+A4-A6; action=keep; destination=flagship paper
...
% PUBMAP kind=remark; labels=rem:chow-gaga; bucket=flagship-interface; lean=A6; action=cite-as-classical; destination=flagship paper
...
% PUBMAP kind=conjecture; labels=conj:hodge-conjecture; bucket=flagship-interface; lean=classical-input; action=keep; destination=flagship paper
...
% PUBMAP kind=remark; labels=rem:hodge-context; bucket=flagship; lean=signed-decomposition; action=keep; destination=flagship paper
...
\end{remark}
% PUBMAP kind=subsection; labels=--; bucket=flagship; lean=A9+A10; action=keep; destination=flagship paper
\subsection*{Main theorem: Hodge conjecture for rational $(p,p)$ classes}
% ============================================================

% PUBMAP kind=theorem; labels=thm:main-hodge; bucket=flagship; lean=A9+A10; action=keep; destination=flagship paper
...
\end{proof}
% PUBMAP kind=remark; labels=rem:main-hodge-discussion; bucket=flagship; lean=A9+A10; action=keep; destination=flagship paper
...
% PUBMAP kind=corollary; labels=cor:full-hodge; bucket=flagship-interface; lean=A9+A10; action=keep; destination=flagship paper
...
% PUBMAP kind=remark; labels=--; bucket=flagship; lean=A9+A10; action=keep; destination=flagship paper
...
% PUBMAP kind=remark; labels=rem:hodge-final-remark; bucket=flagship; lean=A9+A10; action=keep; destination=flagship paper
...
% PUBMAP index inserted automatically
\section*{Publication Map Index}
\begingroup
\footnotesize
\setlength{\LTpre}{0pt}
\setlength{\LTpost}{0pt}
\begin{longtable}{|p{0.18\linewidth}|p{0.27\linewidth}|p{0.13\linewidth}|p{0.13\linewidth}|p{0.19\linewidth}|}
\hline
\textbf{Label} & \textbf{Title} & \textbf{Bucket} & \textbf{Lean} & \textbf{Destination} \\ \hline
\endfirsthead
\hline
\textbf{Label} & \textbf{Title} & \textbf{Bucket} & \textbf{Lean} & \textbf{Destination} \\ \hline
\endhead
\texttt{def:mass} & Mass of an integral current & appendix & classical-input & appendix \\ \hline
\texttt{def:flat-norm} & Flat norm on integral currents & appendix & classical-input & appendix \\ \hline
\texttt{lem:calibrated-cone-closed} & Closure of the calibrated cone & appendix & background & appendix \\ \hline
\texttt{lem:radial-min} & Explicit minimization along a calibrated ray & appendix & background & appendix \\ \hline
\texttt{lem:trace-L2} & Trace $L^{2}$ control & appendix & background & appendix \\ \hline
\texttt{prop:dist-cal-properties} & Well-posedness and basic properties & appendix & background & appendix \\ \hline
\texttt{lem:kahler-angle} & Quadratic control for small Jordan angles (principal angles) & appendix & background & appendix \\ \hline
\texttt{lem:elliptic-coulomb} & Elliptic estimate on the Coulomb slice & appendix & background & appendix \\ \hline
\texttt{lem:coulomb} & Coulomb decomposition and energy identity & appendix & background & appendix \\ \hline
\texttt{lem:covering-number} & Covering number & appendix & background & appendix \\ \hline
\texttt{lem:typesplit} & Off--type separation for $D_{\mathrm{net}}$ & appendix & background & appendix \\ \hline
\texttt{lem:hermitian-model} & Hermitian model for $(p,p)$ & appendix & background & appendix \\ \hline
\texttt{lem:rankone} & Rank--one approximation controls the traceless part & appendix & background & appendix \\ \hline
\texttt{prop:pp-projection} & PSD surrogate for the $(p,p)$ projection & appendix & background & appendix \\ \hline
\texttt{cor:Dpsd-pointwise} & Pointwise rank--one PSD surrogate & appendix & background & appendix \\ \hline
\texttt{thm:cal-coercivity} & Calibration--coercivity (cone-valued harmonic classes, explicit) & appendix & background & appendix \\ \hline
\texttt{thm:spine-quantitative} & Quantitative almost--mass--minimizing cycles & flagship & A10 & flagship paper \\ \hline
\texttt{prop:h1-package} & H1 package: local holomorphic multi-sheet manufacturing & flagship-interface & A10-interface & flagship paper (statement only); companion local paper \\ \hline
\texttt{prop:h2-package} & H2 package: global face coherence and gluing (corner-exit route) & flagship-interface & A10-interface & flagship paper (statement only); companion assembly paper \\ \hline
\texttt{lem:flat\_limit\_of\_cycles\_is\_cycle, lem:cone-closed-seq} & Flat limits of cycles are cycles & formal-supplement & A4 & formal supplement \\ \hline
\texttt{thm:realization-from-almost, thm:cone-closed-FF} & Realization from almost--calibrated sequences & flagship & A4-A6 & flagship paper \\ \hline
\texttt{lem:limit\_is\_calibrated} & Almost--calibrated limits are calibrated & formal-supplement & A4-A6 & formal supplement \\ \hline
\texttt{thm:codim1, thm:lefschetz11} & Codimension one (Lefschetz $(1,1)$) & appendix & classical-input & appendix \\ \hline
\texttt{prop:complete-intersection, thm:complete-intersection} & Complete intersections & appendix & classical-input & appendix \\ \hline
\texttt{def:syr} & Stationary Young--measure realizability (SYR) & flagship-interface & A10 & flagship paper \\ \hline
\texttt{thm:syr, prop:realizability-stationary} & Calibrated realization under SYR & flagship & A4-A6 & flagship paper \\ \hline
\texttt{--} & Locally integrable calibrated decomposition (LICD) & formal-supplement & classical-input & formal supplement \\ \hline
\texttt{thm:classical-syr-licd} & Classical SYR under LICD & formal-supplement & classical-input & formal supplement \\ \hline
\texttt{cor:closure-licd} & Closure of the program under LICD & formal-supplement & classical-input & formal supplement \\ \hline
\texttt{def:caratheodory-decomp} & Carath\'eodory decomposition at a point & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{lem:caratheodory-general} & Uniform Carath\'eodory decomposition & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{lem:lipschitz-qp-weights} & Lipschitz weights from a strongly convex simplex fit & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{lem:jet-surjectivity} & Jet surjectivity for ample powers (pointwise and for finite sets) & companion-local & local-construction & companion local paper \\ \hline
\texttt{lem:bergman-control} & Uniform $C^1$ control on $\mhol^{-1/2}$-balls via Bergman kernels & companion-local & local-construction & companion local paper \\ \hline
\texttt{lem:graph-from-grad, lem:linear-graph-geometry} & Graph control from uniform gradient control & companion-local & local-construction & companion local paper \\ \hline
\texttt{prop:tangent-approx-full, thm:tangent-approx} & Projective tangential approximation with $C^1$ control & companion-local & local-construction & companion local paper \\ \hline
\texttt{prop:dense-holo} & Holomorphic finite-net of calibrated directions near $K$ & companion-local & local-construction & companion local paper \\ \hline
\texttt{lem:complex-corner-exit-template} & A concrete \emph{complex} corner-exit translation template in a cube & companion-local & local-construction & companion local paper \\ \hline
\texttt{lem:small-graph-distortion} & Small-graph distortion & companion-local & local-construction & companion local paper \\ \hline
\texttt{lem:corner-exit-mass-scale} & Corner-exit simplex mass scale and no-heavy-tail uniformity & companion-local & local-construction & companion local paper \\ \hline
\texttt{lem:corner-simplex-face-mass} & {Uniform per--face boundary mass for fat corner simplices} & companion-local & local-construction & companion local paper \\ \hline
\texttt{prop:holomorphic-corner-exit-g1g2} & {Corner--exit footprint geometry for small--slope graphs} & companion-local & local-construction & companion local paper \\ \hline
\texttt{lem:sliver-stability} & Sliver stability under $C^1$-graph perturbations & companion-local & local-construction & companion local paper \\ \hline
\texttt{prop:finite-template} & Realizing a finite translation template locally & companion-local & local-construction & companion local paper \\ \hline
\texttt{prop:holomorphic-corner-exit-L1} & {Corner--exit: $L^1$ interface mass control on boundary faces} & companion-local & local-construction & companion local paper \\ \hline
\texttt{def:holomorphic-scale} & Holomorphic scale & companion-local & local-construction & companion local paper \\ \hline
\texttt{thm:local-sheets} & Local multi-sheet construction & companion-local & local-construction & companion local paper \\ \hline
\texttt{lem:face-trace-decomposition} & Face--trace decomposition as translated template slices & companion-local & local-construction & companion local paper \\ \hline
\texttt{lem:local-bary} & Local barycenter and mass matching on a cube & companion-local & local-construction & companion local paper \\ \hline
\texttt{lem:corner-exit-template-open} & Corner-exit translation templates for a quantitative family of complex planes & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{prop:corner-exit-template-net} & Robust corner-exit templates for a finite direction net & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{thm:global-cohom} & Global cohomology quantization & companion-assembly & exact-class-locking & companion assembly paper \\ \hline
\texttt{def:coherent-templates} & Coherent templates & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{lem:coherence-implies-closed} & Coherence implies closed & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{def:face-maps} & Face basepoints and linear face maps & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{lem:face-map-stability} & Uniform stability of face maps & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{prop:transport-flat-glue, prop:transport-cell} & Transport control $\Rightarrow$ flat-norm gluing & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{lem:w1-auto} & Automatic $W_1$-matching from smooth dependence of face maps & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{def:cell-transport-plan} & Cell transport plan & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{lem:w1-integral-optimal, lem:transport-exists} & Integral optimal couplings for discrete integer measures & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{lem:face-displacement} & Pointwise displacement bound under nearby face maps & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{lem:w1-template-edit} & Template stability under small multiset edits & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{def:sliver-cell} & Sliver cell & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{prop:sliver-cell-mass-proportions} & Quantizing a cell mass budget by many equal-scale pieces & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{lem:flat-translate} & Flat-norm stability under translation & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{lem:flat-C0-deform} & Flat-norm stability under small $C^0$ deformations & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{lem:flat-diameter} & Flat norm of a cycle supported in diameter $\lesssim h$ & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{lem:template-displacement} & Template displacement $\Rightarrow$ per-face flat-norm mismatch & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{lem:template-displacement-edits} & Template displacement with insertions/deletions & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{lem:template-edits-oh} & If edits are an $O(h)$ fraction, they are $h^2$ in flat norm & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{prop:prefix-template-coherence} & Prefix templates $\Rightarrow$ interface coherence up to $O(h)$ edits & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{prop:sliver-template-extension} & Prefix mismatch decomposition & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{prop:transport-flat-glue-weighted} & Weighted transport $\Rightarrow$ flat-norm face control (sliver-compatible) & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{prop:integer-transport} & Integer transverse matching from the master prefix template (constructed here) & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{lem:uniformly-convex-slice-boundary} & Boundary shrinkage for plane slices in smooth uniformly convex cells & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{lem:face-slice-cycle-mass} & {Interface face-slices are cycles with controlled mass} & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{cor:global-flat-weighted} & Global flat-norm bound from weighted face control (sliver-compatible) & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{lem:borderline-p-half} & Borderline ($p=n/2$): closure via a refined displacement schedule & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{lem:sliver-template-glue-flat} & Flat gluing bound from prefix coherence & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{prop:sliver-template-glue} & Summing face mismatches & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{prop:sliver-template-global} & Global flat bound in the sliver regime & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{prop:sliver-mass-matching} & Local mass matching on a fixed template & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{thm:sliver-mass-matching-on-template} & Global prefix-template activation / mass matching (template bookkeeping) & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{prop:prefix-activation-flat-ball} & Flat-ball model: prefix activation is feasible & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{cor:prefix-activation-holo} & Holomorphic prefix activation on a Bergman-scale ball cell & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{lem:oh-face-edit-regime} & A sufficient condition for the $O(h)$ face-edit regime & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{lem:mass-tunable} & Mass tunability of plane slices in the flat model & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{lem:sphere-quantize} & Quantizing a Lipschitz density on a sphere & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{lem:sphere-quantize-nested} & Nested equal-weight quantization of the uniform sphere & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{prop:flat-sliver-local} & Flat ball model slivers achieve $W_1$ transverse approximation & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{cor:holomorphic-flat-sliver-local} & Holomorphic upgrade on a ball cell & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{conj:sliver-local} & Local sliver-sheet realizability (quantitative target) & companion-assembly & packet-assembly & companion assembly paper \\ \hline
\texttt{def:vertex-template} & Global vertex template (flat cubical model) & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{lem:vertex-template-exists} & Existence of vertex-template families in the flat cubical model & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{lem:cube-vertex-slice-boundary} & Corner-exit simplex slices have optimal boundary scaling & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{prop:vertex-template-mass-matching} & Vertex-template prefix lengths match local mass budgets (L2, cube model) & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{prop:vertex-template-face-edits} & Vertex templates $\Rightarrow$ face-level $O(h)$ edit regime (hypothesis \textnormal{(iv)}) & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{cor:corner-exit-iii-iv} & Corner-exit vertex templates satisfy the activation hypotheses (iii)--(iv) & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{prop:global-coherence-all-labels} & Global coherence across all direction labels (B1, packaged) & companion-assembly & A10-interface & companion assembly paper \\ \hline
\texttt{prop:cohomology-match} & Integral cohomology constraints & flagship & exact-class-locking & flagship paper \\ \hline
\texttt{prop:almost-calibration} & Almost--calibration and global mass convergence for the glued cycles & flagship & A10 & flagship paper \\ \hline
\texttt{cor:raw-boundary-flat-small, prop:global-flat-control} & Flat boundary of the raw current in the weighted scaling regime & companion-assembly & A10-interface & companion assembly paper \\ \hline
\texttt{def:checkerboard-anchoring} & Cubical grid parity and checkerboard vertex anchoring & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{def:block-uniform-codes} & Block-uniform vertex-code sequence & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{lem:prefix-discrepancy, lem:template-vertex-control} & Prefix discrepancy for block-uniform codes & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{lem:two-sided-face-pop} & Two-sided face population is automatic under checkerboarding & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{prop:checkerboard-face-oh-edit, prop:template-edits} & Checkerboard corner assignment implies a face-level $O(h)$ edit regime & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{lem:global-graph-contraction} & Global quantitative graph lemma (contraction criterion) & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{lem:bergman-affine-approx-hormander} & Bergman-scale affine model approximation via $\bar\partial$-solving & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{prop:cell-scale-linear-model-graph} & Cell-scale linear-model complete intersections are single-sheet graphs & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{def:graph-template} & Graph template on a cube & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{lem:graph-template-exists} & Linear-model sheets yield whole-cell graph templates & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{def:graph-restriction-maps} & Face/vertex restriction maps for graph templates & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{prop:graph-template-transport} & Integral transport for graph-template measures & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{lem:graph-template-flat-control} & Flat-norm control from face transport in the graph-template variant & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{prop:graph-template-global} & Global gluing for graph templates & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{lem:graph-boundary-correction} & Boundary correction for graph-template assemblies & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{lem:ball-excludes-faces} & Vertex-ball locality excludes nonincident faces & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{lem:corner-simplex-hits-designated-faces} & {Fat corner simplices force ``if'' on the designated exit faces} & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{cor:holomorphic-corner-exit-inherits} & {Corner--exit faces persist uniformly across a finite template family} & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{lem:sliver-packing} & Packing bound for disjoint sliver graphs & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{lem:slow-variation-rounding} & Slow variation under rounding of Lipschitz targets & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{lem:vertex-template-discrete} & Discrete vertex-template selection & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{prop:vertex-template-transport} & Integral transport at vertices & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{prop:graph-vertex-compatibility} & Compatibility of graph and vertex bookkeeping & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{prop:graph-global-coherence} & Global coherence in the graph-template regime & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{lem:slow-variation-discrepancy} & Slow variation persists under $0$--$1$ discrepancy rounding & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{lem:per-cell-flat-control} & Per-face flat control from transport & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{lem:flatnorm-gluing-mismatch} & Flat-norm control of the gluing mismatch & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{lem:FF-filling-X} & Federer--Fleming filling on $X$ for bounding cycles & formal-supplement & A4 & formal supplement \\ \hline
\texttt{prop:glue-gap, prop:glue-cell} & Microstructure/gluing estimate & flagship & A10 & flagship paper \\ \hline
\texttt{lem:barany-grinberg} & Fixed-dimension discrepancy rounding (B\'ar\'any--Grinberg) & formal-supplement & exact-class-locking & formal supplement \\ \hline
\texttt{lem:integral-periods} & Integral periods of integral cycles & formal-supplement & classical-input & formal supplement \\ \hline
\texttt{lem:boundary-template} & Boundary template bookkeeping & formal-supplement & A10 & formal supplement \\ \hline
\texttt{thm:boundary-correction} & Boundary correction with vanishing mass & formal-supplement & A10 & formal supplement \\ \hline
\texttt{def:lattice-template} & Lattice template & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{lem:lattice-template-exists} & Lattice template exists from integer data & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{prop:lattice-template-transport} & Integral transport for lattice templates & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{prop:lattice-template-global} & Global assembly for lattice templates & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{lem:lattice-vertex-control} & Vertex control for lattice templates & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{prop:lattice-vertex-compatibility} & Vertex compatibility for lattice templates & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{prop:lattice-global-coherence} & Global coherence for lattice templates & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{lem:lattice-discreteness} & Lattice discreteness & formal-supplement & formal-audit & formal supplement \\ \hline
\texttt{thm:syr-realization} & SYR Realization & formal-supplement & A4-A6 & formal supplement \\ \hline
\texttt{cor:syr-limit-holomorphic-chain} & SYR limit is a holomorphic (hence algebraic) cycle & formal-supplement & A4-A6 & formal supplement \\ \hline
\texttt{thm:automatic-syr} & Automatic SYR for cone-valued forms & flagship & A10 & flagship paper \\ \hline
\texttt{--} & Cone--positive class (smooth $K_p$--positive) & flagship & signed-decomposition & flagship paper \\ \hline
\texttt{lem:kahler-positive} & Strict interior positivity of the K\"ahler power & flagship-interface & signed-decomposition & flagship paper \\ \hline
\texttt{lem:signed-decomp, thm:signed-decomp} & Signed Decomposition & flagship & signed-decomposition & flagship paper \\ \hline
\texttt{cor:signed-decomp-usage} & Reduction to cone--positive classes & flagship-interface & signed-decomposition & flagship paper \\ \hline
\texttt{lem:gamma-minus-alg} & $\omega^p$ is algebraic & flagship & classical-input & flagship paper \\ \hline
\texttt{thm:effective-algebraic} & Cone--positive classes are algebraic & flagship & A10+A4-A6 & flagship paper \\ \hline
\texttt{conj:hodge-conjecture} & Hodge Conjecture & flagship-interface & classical-input & flagship paper \\ \hline
\texttt{thm:main-hodge} & Hodge Conjecture for rational $(p,p)$ classes & flagship & A9+A10 & flagship paper \\ \hline
\texttt{cor:full-hodge} & Full Hodge conjecture & flagship-interface & A9+A10 & flagship paper \\ \hline
\end{longtable}
\endgroup
\end{document}

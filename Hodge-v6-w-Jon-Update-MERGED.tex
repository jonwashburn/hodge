...
\end{proposition}
\begin{proof}
Fix an interface $F=Q\cap Q'$ and a matching $\sigma_F$ as in the hypothesis.
...
\ \le\ \Delta_F\sum_{a=1}^{N_F}\Mass(\Sigma_F(u_{F,a})).
\]
Summing over all interfaces and setting $U:=\sum_F Q_F$ gives an integral current with
\[
